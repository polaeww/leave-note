...
<section class="wrapper">
    <br>
    <h3><i class="fa fa-angle-right"></i> สร้างใบลา</h3>
    <div class="row mt">
        <div class="col-lg-12">
            <div class="form-panel">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input style="margin-left: 20px" type="radio" name="leave_length_type_id" value="{{$leave_length_type->id}}">                        {{$leave_length_type->name}} @endforeach()
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-1"></div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                ...
                                                <input style="margin-left: 20px" type="radio" name="leave_type_id" value="{{$leave_type->id}}">                                                {{$leave_type->name}} @endforeach()
                                            </td>
